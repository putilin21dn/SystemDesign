...
class WorkoutExercisesHandler final
    : public userver::server::handlers::HttpHandlerBase {
 public:
  static constexpr std::string_view kName = "handler-workout-exercises";

  WorkoutExercisesHandler(const userver::components::ComponentConfig& config,
